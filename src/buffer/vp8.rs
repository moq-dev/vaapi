...
impl VP8PicFields {
	...
	pub fn new(
		...
		let _bitfield_1 = bindings::_VAPictureParameterBufferVP8__bindgen_ty_1__bindgen_ty_1::new_bitfield_1(
			key_frame,
			version,
...
impl BoolCoderContextVPX {
	...
	pub fn new(range: u8, value: u8, count: u8) -> Self {
		Self(bindings::VABoolCoderContextVPX { range, value, count })
	}
}
...
impl VP8EncRefFlags {
	pub fn new(
		...
		let _bitfield_1 = bindings::_VAEncPictureParameterBufferVP8__bindgen_ty_1__bindgen_ty_1::new_bitfield_1(
			force_kf,
			no_ref_last,
			no_ref_gf,
			no_ref_arf,
...
impl VP8EncPicFlags {
	...
	pub fn new(
		...
		let _bitfield_1 = bindings::_VAEncPictureParameterBufferVP8__bindgen_ty_2__bindgen_ty_1::new_bitfield_1(
			frame_type,
			version,
			show_frame,
			color_space,
