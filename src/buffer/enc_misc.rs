...
#[derive(Default)]
pub struct EncMiscParameterFrameRate(Box<MiscEncParamBuffer<bindings::VAEncMiscParameterFrameRate>>);
...
impl EncMiscParameterFrameRate {
	pub fn new(framerate: u32, temporal_id: u32) -> Self {
		...
		let _bitfield_1 = bindings::_VAEncMiscParameterFrameRate__bindgen_ty_1__bindgen_ty_1::new_bitfield_1(
			temporal_id,
			Default::default(),
		);
	...
	pub(crate) fn inner_mut(&mut self) -> &mut MiscEncParamBuffer<bindings::VAEncMiscParameterFrameRate> {
		&mut self.0
	}
}
...
impl RcFlags {
	pub fn new(
		...
		let _bitfield_1 = bindings::_VAEncMiscParameterRateControl__bindgen_ty_1__bindgen_ty_1::new_bitfield_1(
			reset,
			disable_frame_skip,
...
#[derive(Default)]
pub struct EncMiscParameterRateControl(Box<MiscEncParamBuffer<bindings::VAEncMiscParameterRateControl>>);
...
impl EncMiscParameterRateControl {
	...
	pub(crate) fn inner_mut(&mut self) -> &mut MiscEncParamBuffer<bindings::VAEncMiscParameterRateControl> {
		&mut self.0
	}
}

#[derive(Default)]
pub struct EncMiscParameterMaxSliceSize(Box<MiscEncParamBuffer<bindings::VAEncMiscParameterMaxSliceSize>>);
...
impl EncMiscParameterMaxSliceSize {
	...
	pub(crate) fn inner_mut(&mut self) -> &mut MiscEncParamBuffer<bindings::VAEncMiscParameterMaxSliceSize> {
		&mut self.0
	}
}

#[derive(Default)]
pub struct EncMiscParameterBufferMaxFrameSize(Box<MiscEncParamBuffer<bindings::VAEncMiscParameterBufferMaxFrameSize>>);
...
impl EncMiscParameterBufferMaxFrameSize {
	...
	pub(crate) fn inner_mut(&mut self) -> &mut MiscEncParamBuffer<bindings::VAEncMiscParameterBufferMaxFrameSize> {
		&mut self.0
	}
}

#[derive(Default)]
pub struct EncMiscParameterSkipFrame(Box<MiscEncParamBuffer<bindings::VAEncMiscParameterSkipFrame>>);
...
impl EncMiscParameterSkipFrame {
	...
	pub(crate) fn inner_mut(&mut self) -> &mut MiscEncParamBuffer<bindings::VAEncMiscParameterSkipFrame> {
		&mut self.0
	}
}
...
#[derive(Default)]
pub struct EncMiscParameterBufferQualityLevel(Box<MiscEncParamBuffer<bindings::VAEncMiscParameterBufferQualityLevel>>);
...
impl EncMiscParameterBufferQualityLevel {
	...
	pub(crate) fn inner_mut(&mut self) -> &mut MiscEncParamBuffer<bindings::VAEncMiscParameterBufferQualityLevel> {
		&mut self.0
	}
}

#[derive(Default)]
pub struct EncMiscParameterQuantization(Box<MiscEncParamBuffer<bindings::VAEncMiscParameterQuantization>>);

impl EncMiscParameterQuantization {
	pub fn new(disable_trellis: bool, enable_trellis_i: bool, enable_trellis_p: bool, enable_trellis_b: bool) -> Self {
		let _bitfield_1 = bindings::_VAEncMiscParameterQuantization__bindgen_ty_1__bindgen_ty_1::new_bitfield_1(
	...
	pub(crate) fn inner_mut(&mut self) -> &mut MiscEncParamBuffer<bindings::VAEncMiscParameterQuantization> {
		&mut self.0
	}
}
