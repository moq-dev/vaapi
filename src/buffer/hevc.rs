...
impl HevcPicFields {
	...
	pub fn new(
		...
		let _bitfield_1 = bindings::_VAPictureParameterBufferHEVC__bindgen_ty_1__bindgen_ty_1::new_bitfield_1(
			chroma_format_idc,
...
impl HevcSliceParsingFields {
	...
	pub fn new(
		...
		let _bitfield_1 = bindings::_VAPictureParameterBufferHEVC__bindgen_ty_2__bindgen_ty_1::new_bitfield_1(
...
impl HevcRangeExtensionPicFields {
	...
	pub fn new(
		...
		let _bitfield_1 = bindings::_VAPictureParameterBufferHEVCRext__bindgen_ty_1__bindgen_ty_1::new_bitfield_1(
...
impl HevcScreenContentPicFields {
	...
	pub fn new(
		...
		let _bitfield_1 = bindings::_VAPictureParameterBufferHEVCScc__bindgen_ty_1__bindgen_ty_1::new_bitfield_1(
...
impl HevcLongSliceFlags {
	...
	pub fn new(
		...
		let _bitfield_1 = bindings::_VASliceParameterBufferHEVC__bindgen_ty_1__bindgen_ty_1::new_bitfield_1(
			last_slice_of_pic,
...
impl HevcSliceExtFlags {
	...
	pub fn new(cu_chroma_qp_offset_enabled_flag: u32, use_integer_mv_flag: u32) -> Self {
		let _bitfield_1 = bindings::_VASliceParameterBufferHEVCRext__bindgen_ty_1__bindgen_ty_1::new_bitfield_1(
...
impl HEVCEncSeqFields {
	...
	pub fn new(
		...
		let _bitfield_1 = bindings::_VAEncSequenceParameterBufferHEVC__bindgen_ty_1__bindgen_ty_1::new_bitfield_1(
			chroma_format_idc,
			separate_colour_plane_flag,
			bit_depth_luma_minus8,
			bit_depth_chroma_minus8,
...
impl HevcEncVuiFields {
	...
	pub fn new(
		...
		let _bitfield_1 = bindings::_VAEncSequenceParameterBufferHEVC__bindgen_ty_2__bindgen_ty_1::new_bitfield_1(
...
impl HevcEncSeqSccFields {
	pub fn new(palette_mode_enabled_flag: u32) -> Self {
		let _bitfield_1 = bindings::_VAEncSequenceParameterBufferHEVC__bindgen_ty_3__bindgen_ty_1::new_bitfield_1(
			palette_mode_enabled_flag,
			Default::default(),
		);
...
impl HEVCEncPicFields {
	...
	pub fn new(
		...
		let _bitfield_1 = bindings::_VAEncPictureParameterBufferHEVC__bindgen_ty_1__bindgen_ty_1::new_bitfield_1(
			idr_pic_flag,
			coding_type,
			reference_pic_flag,
			dependent_slice_segments_enabled_flag,
...
impl HevcEncPicSccFields {
	pub fn new(pps_curr_pic_ref_enabled_flag: u16) -> Self {
		let _bitfield_1 = bindings::_VAEncPictureParameterBufferHEVC__bindgen_ty_2__bindgen_ty_1::new_bitfield_1(
			pps_curr_pic_ref_enabled_flag,
			Default::default(),
		);
...
impl HevcEncSliceFields {
	...
	pub fn new(
		...
		let _bitfield_1 = bindings::_VAEncSliceParameterBufferHEVC__bindgen_ty_1__bindgen_ty_1::new_bitfield_1(
