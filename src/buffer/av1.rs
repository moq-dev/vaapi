...
impl AV1SeqFields {
	...
	pub fn new(
		...
		let _bitfield_1 = bindings::_VADecPictureParameterBufferAV1__bindgen_ty_1__bindgen_ty_1::new_bitfield_1(
			still_picture,
...
impl AV1SegmentInfoFields {
	...
	pub fn new(enabled: u32, update_map: u32, temporal_update: u32, update_data: u32) -> Self {
		let _bitfield_1 = bindings::_VASegmentationStructAV1__bindgen_ty_1__bindgen_ty_1::new_bitfield_1(
			enabled,
			update_map,
			temporal_update,
			update_data,
...
impl AV1FilmGrainFields {
	...
	pub fn new(
		...
		let _bitfield_1 = bindings::_VAFilmGrainStructAV1__bindgen_ty_1__bindgen_ty_1::new_bitfield_1(
			apply_grain,
...
impl AV1PicInfoFields {
	...
	pub fn new(
		...
		let _bitfield_1 = bindings::_VADecPictureParameterBufferAV1__bindgen_ty_2__bindgen_ty_1::new_bitfield_1(
			frame_type,
			show_frame,
			showable_frame,
...
impl AV1LoopFilterFields {
	...
	pub fn new(sharpness_level: u8, mode_ref_delta_enabled: u8, mode_ref_delta_update: u8) -> Self {
		let _bitfield_1 = bindings::_VADecPictureParameterBufferAV1__bindgen_ty_3__bindgen_ty_1::new_bitfield_1(
			sharpness_level,
...
impl AV1WarpedMotionParams {
	/// Creates the wrapper
	pub fn new(wmtype: bindings::VAAV1TransformationType::Type, wmmat: [i32; 8], invalid: u8) -> Self {
...
impl AV1LoopRestorationFields {
	...
	pub fn new(
		...
		let _bitfield_1 = bindings::_VADecPictureParameterBufferAV1__bindgen_ty_6__bindgen_ty_1::new_bitfield_1(
...
impl AV1ModeControlFields {
	...
	pub fn new(
		...
		let _bitfield_1 = bindings::_VADecPictureParameterBufferAV1__bindgen_ty_5__bindgen_ty_1::new_bitfield_1(
...
impl AV1QMatrixFields {
	...
	pub fn new(using_qmatrix: u16, qm_y: u16, qm_u: u16, qm_v: u16) -> Self {
		let _bitfield_1 = bindings::_VADecPictureParameterBufferAV1__bindgen_ty_4__bindgen_ty_1::new_bitfield_1(
			using_qmatrix,
			qm_y,
			qm_u,
			qm_v,
...
impl PictureParameterBufferAV1 {
	...
	pub fn new(
		...
		let wm = wm.iter().map(|wm| wm.0).collect::<Vec<_>>().try_into().unwrap();
...
impl AV1EncSeqFields {
	pub fn new(
		...
		let _bitfield_1 = bindings::_VAEncSequenceParameterBufferAV1__bindgen_ty_1__bindgen_ty_1::new_bitfield_1(
			still_picture,
			use_128x128_superblock,
			enable_filter_intra,
			enable_intra_edge_filter,
...
impl AV1EncLoopFilterFlags {
	pub fn new(sharpness_level: u8, mode_ref_delta_enabled: bool, mode_ref_delta_update: bool) -> Self {
		let mode_ref_delta_enabled = mode_ref_delta_enabled as u8;
		let mode_ref_delta_update = mode_ref_delta_update as u8;

		let _bitfield_1 = bindings::_VAEncPictureParameterBufferAV1__bindgen_ty_2__bindgen_ty_1::new_bitfield_1(
			sharpness_level,
			mode_ref_delta_enabled,
			mode_ref_delta_update,
			Default::default(),
...
impl AV1EncQMatrixFlags {
	pub fn new(using_qmatrix: bool, qm_y: u16, qm_u: u16, qm_v: u16) -> Self {
		...
		let _bitfield_1 = bindings::_VAEncPictureParameterBufferAV1__bindgen_ty_3__bindgen_ty_1::new_bitfield_1(
			using_qmatrix,
			qm_y,
			qm_u,
			qm_v,
...
impl AV1EncModeControlFlags {
	pub fn new(
		...
		let _bitfield_1 = bindings::_VAEncPictureParameterBufferAV1__bindgen_ty_4__bindgen_ty_1::new_bitfield_1(
			delta_q_present,
			delta_q_res,
			delta_lf_present,
			delta_lf_res,
...
impl EncSegParamFlagsAV1 {
	pub fn new(segmentation_enabled: bool, segmentation_update_map: bool, segmentation_temporal_update: bool) -> Self {
...
impl AV1EncLoopRestorationFlags {
	pub fn new(
		...
		let _bitfield_1 = bindings::_VAEncPictureParameterBufferAV1__bindgen_ty_5__bindgen_ty_1::new_bitfield_1(
			yframe_restoration_type,
			cbframe_restoration_type,
			crframe_restoration_type,
			lr_unit_shift,
...
impl EncWarpedMotionParamsAV1 {
	pub fn new(wmtype: bindings::VAEncTransformationTypeAV1::Type, wmmat: [i32; 8usize], invalid: u8) -> Self {
...
impl AV1EncTileGroupObuHdrInfo {
	pub fn new(obu_extension_flag: bool, obu_has_size_field: bool, temporal_id: u8, spatial_id: u8) -> Self {
		let obu_extension_flag = obu_extension_flag as u8;
		let obu_has_size_field = obu_has_size_field as u8;

		let _bitfield_1 = bindings::_VAEncPictureParameterBufferAV1__bindgen_ty_6__bindgen_ty_1::new_bitfield_1(
			obu_extension_flag,
			obu_has_size_field,
			temporal_id,
			spatial_id,
