...
impl PictureParameterBufferJPEGBaselineComponent {
	...
	pub fn new(component_id: u8, h_sampling_factor: u8, v_sampling_factor: u8, quantiser_table_selector: u8) -> Self {
...
impl IQMatrixBufferJPEGBaseline {
	/// Creates the wrapper.
	#[allow(clippy::too_many_arguments)]
	pub fn new(load_quantiser_table: [u8; 4usize], quantiser_table: [[u8; 64usize]; 4usize]) -> Self {
