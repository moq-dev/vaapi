...
impl H264SeqFields {
	...
	pub fn new(
		...
		let _bitfield_1 = bindings::_VAPictureParameterBufferH264__bindgen_ty_1__bindgen_ty_1::new_bitfield_1(
			chroma_format_idc,
...
impl H264PicFields {
	...
	pub fn new(
		...
		let _bitfield_1 = bindings::_VAPictureParameterBufferH264__bindgen_ty_2__bindgen_ty_1::new_bitfield_1(
...
impl IQMatrixBufferH264 {
	/// Creates the wrapper.
	pub fn new(scaling_list4x4: [[u8; 16usize]; 6usize], scaling_list8x8: [[u8; 64usize]; 2usize]) -> Self {
...
impl H264EncSeqFields {
	...
	pub fn new(
		...
		let _bitfield_1 = bindings::_VAEncSequenceParameterBufferH264__bindgen_ty_1__bindgen_ty_1::new_bitfield_1(
			chroma_format_idc,
			frame_mbs_only_flag,
			mb_adaptive_frame_field_flag,
...
impl H264VuiFields {
	...
	pub fn new(
		...
		let _bitfield_1 = bindings::_VAEncSequenceParameterBufferH264__bindgen_ty_2__bindgen_ty_1::new_bitfield_1(
...
impl H264EncPicFields {
	...
	pub fn new(
		...
		let _bitfield_1 = bindings::_VAEncPictureParameterBufferH264__bindgen_ty_1__bindgen_ty_1::new_bitfield_1(
			idr_pic_flag,
			reference_pic_flag,
			entropy_coding_mode_flag,
			weighted_pred_flag,
...
impl H264EncMacroblockInfo {
	pub fn new_intra(pred_avail_override_flag: u32, pred_avail_flags: u32) -> Self {
		let _bitfield_1 =
			bindings::_VAEncMacroblockParameterBufferH264__bindgen_ty_1__bindgen_ty_1__bindgen_ty_1::new_bitfield_1(
